public class Runner {
    ...
    public static void rectangleDemo(){
        ...
        int area = rectangle.calculatedArea();
        System.out.println("The rectangle has an area of " + area);

        // 3. Check if your rectangle is actually a square
        boolean isItSquare = rectangle.isSquare();
        System.out.println("Object is a square: " + isItSquare);
    }
    ...
    public static void computerDemo(){
        ...
        Computer computer = new Computer(256);
